<template>
      ...
      <div class="inner">
        ...
        <ul class="footer-sns clearfix">
          <li><a href="#"><img src="../assets/images/f_blog.png" alt=""></a></li>
          <li><a href="#"><img src="../assets/images/f_insta.png" alt=""></a></li>
          <li><a href="#"><img src="../assets/images/f_facebook.png" alt=""></a></li>
        </ul>
      </div>
    </footer>
</template>
